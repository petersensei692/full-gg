  ...
  return (
    ...
    <div className="rounded-xl border border-sidebar-border bg-sidebar/50 p-3 mt-6">
      ...
      <div className="mt-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between min-w-0">
        ...
        <div className="flex items-center gap-2 min-w-0 w-full sm:w-auto sm:justify-end">
          <ScrollableSelect
            value={analysisType}
          ...
          <button
            ...
            className="flex flex-1 sm:flex-initial items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:pointer-events-none shrink-0 min-w-0"
          >
